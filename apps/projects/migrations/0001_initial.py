    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['position'],
                'constraints': [models.UniqueConstraint(fields=('project', 'status'), name='unique_project_status'), models.UniqueConstraint(fields=('project', 'position'), name='unique_project_status_position')],
            },
        ),
    ]
